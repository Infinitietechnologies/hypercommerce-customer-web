...
export type Settings = [
  ...
  {
    variable: "markets";
    value: MarketsSetting;
  },
];

// hypercommerce: markets block returned inside /settings
...
export interface ProductVariant {
  ...
  // Market-aware pricing (hypercommerce). price/special_price are already
  // FX-converted to the active market; *_base are the seller's base currency.
  price_base?: number;
...
export interface Store {
  ...
  banner: string;
  address?: string;
  // Geo fields no longer returned by the market-based backend — kept optional
  ...
  avg_store_rating: string | number;
  avg_products_rating?: string | number;
  ...
  metadata?: SEOMetadata | string | null;
  is_recommended?: boolean;
  // hypercommerce additions
  seller_id?: number;
  currency_code?: string;
  verification_status?: string;
  visibility_status?: string;
  markets?: Pick<Market, "id" | "code" | "name">[];
}
...
export interface GeoDetectData {
  ...
  suggested_market: Market | null;
  source: string;
}

/* ---------------- Home layout (hypercommerce) ---------------- */
...
export interface HomeHeroItem {
  ...
  type: string | null; // product | category | brand
...
export interface HomeBannerItem {
  id: number;
  image: string | null;
  link_type: string | null; // custom | product | category | brand
...
export interface HomeSection {
  ...
  title: string | null;
  style: string | null; // carousel | grid
  config: { source?: string; limit?: number; [key: string]: unknown };
