  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <div className="bg-white/80 dark:bg-slate-900/90 backdrop-blur-2xl border border-slate-200/50 dark:border-slate-800/50 shadow-[0_20px_50px_rgba(0,0,0,0.15)] rounded-[2rem] p-3 ps-6 flex items-center justify-between gap-4">
