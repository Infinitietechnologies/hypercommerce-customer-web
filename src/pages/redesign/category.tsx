// /redesign/category — category detail with filter rail and sort.
// Source: CATEGORY DETAIL block of `HyperCommerce App.dc.html`.
...
import { CATEGORIES, INITIAL_CART, PRODUCTS } from "@/redesign/data/mock";
...
const CategoryDetailPage: NextPageWithLayout = () => {
  ...
  const category =
    CATEGORIES.find((c) => c.slug === router.query.slug) ?? CATEGORIES[0];
...
CategoryDetailPage.getLayout = (page) => page;
