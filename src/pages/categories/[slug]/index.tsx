          ...
          <div className="flex gap-2 flex-col md:flex-row">
            ...
            <div className="flex-1 pb-28 md:pb-0">
              ...
              <InfiniteScroll
                ...
                onLoadMore={loadMore}
              >
                <div className="grid grid-cols-1 gap-2 xs:grid-cols-2 md:grid-cols-4 lg:grid-cols-5">
                ...
                {isLoadingMore && (
                  <div className="mt-6 grid grid-cols-1 gap-2 xs:grid-cols-2 md:grid-cols-4 lg:grid-cols-5">
                    {Array.from({ length: PER_PAGE }).map((_, i) => (
