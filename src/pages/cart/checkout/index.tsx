...
const CheckoutPageView = dynamic(() => import("@/views/CheckoutPageView"), {
  ssr: false,
});
...
const CheckoutPage: NextPageWithLayout<CheckoutPageProps> = () => {
  ...
  return (
    <>
      <PageHead pageTitle={t("pageTitle.checkout", { defaultValue: "Checkout" })} />
