    ...
    >
      <div className="mx-auto max-w-site">
        <div className="mb-2 flex items-center justify-between gap-3">
          ...
          <span className="inline-flex items-center gap-1 rounded-full bg-content2 px-3 py-1 text-xs font-semibold text-default-600">
            <Icon icon="solar:play-stream-linear" className="text-base" />
            {t("watchBuy.reels.label")}
          </span>
        </div>
