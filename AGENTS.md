# AGENTS.md — HyperCommerce Customer Web
...
└── src/
    ...
    ├── features/               # ★ feature modules for NEW work — see its AGENTS.md
...
- Mention Codex, AI, assistants, or prompts in code, comments, or commits.
...
- Never mention Codex, AI, or prompts in commit messages.

### Nested AGENTS.md files — precedence

Six exist. **This file wins on conflict**, then the nearest subfolder file:

| File | Scope | Status |
|---|---|---|
| `AGENTS.md` (this file) | whole app | **authoritative** |
| `src/AGENTS.md` | navigation map, where-to-put-code | accurate |
| `src/pages/AGENTS.md` | Pages Router patterns | accurate |
| `src/routes/AGENTS.md` | api.ts / interceptor | accurate |
| `src/lib/redux/AGENTS.md` | slices, store, persist | accurate |
| `src/components/AGENTS.md` | component contract + the `ui/` layer | accurate |
| `src/features/AGENTS.md` | feature module shape for new work | accurate |

All six are current as of Phase 2.

### Before every task
1. Read this file, `GAP_ANALYSIS.md`, `THEME_REDESIGN.md`, `REDESIGN_QUESTIONS.md`, and the nearest subfolder `AGENTS.md`.
