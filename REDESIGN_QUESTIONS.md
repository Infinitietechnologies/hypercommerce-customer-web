...
- `/watch-and-buy` combines a Stories rail and a vertically snapping Reels feed. Statuses use the existing 24-hour profile grouping; Reels expose only supported actions: like, share, profile story, and linked products.
